...
class SharedDashboardLayout extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SharedDashboardLayout> createState() => _SharedDashboardLayoutState();
}

class _SharedDashboardLayoutState extends ConsumerState<SharedDashboardLayout> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: !useSidebar ? AppBar(
        title: Text(widget.items[_selectedIndex].label, style: AppTextStyles.title(context)),
        actions: [
          IconButton(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(role, style: AppTextStyles.muted(context, size: 12)),
                  ],
                ),
              ],
            ),
...
class _SidebarTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final inactiveColor = cs.onSurface.withValues(alpha: 0.6);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          const SizedBox(width: 14),
          Text(label, style: TextStyle(fontSize: 15, fontFamily: 'Inter', fontWeight: FontWeight.w500, color: cs.onSurface.withValues(alpha: 0.7))),
        ]),
      ),
    );
  }
