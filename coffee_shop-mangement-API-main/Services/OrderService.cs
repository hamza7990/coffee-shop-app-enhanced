...
public class OrderService : IOrderService
{
    ...
    public async Task<PagedResult<OrderDto>> GetOrdersAsync(int page, int pageSize, OrderStatus? status, int? cashierId = null)
    {
        ...
        if (cashierId.HasValue) query = query.Where(o => o.CashierId == cashierId.Value);
